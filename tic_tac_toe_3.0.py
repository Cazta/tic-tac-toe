...
def start_function():
    ...
    start = input('Hit any key to start paying Tic-Tac-Toe!')
    if start != None:
        game_active = True
...
#move player
def move_player(active_player, game_board):
    ...
    if idx not in range(0,9):
        ...
        move_player(active_player, game_board)
